    ...
    >
      <div className={`w-full flex justify-between items-center max-w-7xl mx-auto`}>
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          ...
          />
          <div className={`${!toggle ? " translate-y-full " : "  translate-y-0 "} transition-all flex h-screen p-6 bg-gradient absolute top-10 right-0 my-2 min-w-[180px] bg-black z-10 rounded-xl `}>
