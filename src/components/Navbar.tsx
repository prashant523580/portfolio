    ...
    >
        <div className={`w-full flex justify-between items-center max-w-7xl mx-auto`}>
          ...
          <div className="sm:hidden flex flex-1 justify-end items-center">
            ...
            />
            <div className={`${!toggle ? "hidden" :"flex"} p-6 bg-gradient absolute top-10 right-0 my-2 min-w-[140px] z-10 rounded-xl `}>
            <ul className='list-none flex justify-end items-start flex-col  gap-4 bg-black'>
            {
              navLinks.map((link) => (
                <li key={link.id}
                onClick={() => {
